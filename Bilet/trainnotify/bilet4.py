...
def welcome(message):
    ...
    item4 = types.KeyboardButton("Остановить поиск")
                ...
                try:
                    ...
                    while True:
                        try:
                            ...
                            try:
                                driver.find_element(By.XPATH, "//span[@class='spinner spinner-large spinner-blue spinner-slow']")
                            except:
                    ...
                    try:
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    driver.find_element(By.XPATH,
                                                        f"""//*[contains(text(),"{train}")]/following::div[@class='info__part info__part--third'][1]//span[contains(text(),"0")]
                        ...
                        while True:
                            try:
                                ...
                                print(name)
                                driver.find_element(By.XPATH,
                                                    f"""//div[@class='ng-dropdown-panel-items scroll-host']//span[contains(text(),"{name}")]""").click()  #f"//span[contains(text(),'{name}')]"
                                driver.find_element(By.XPATH, "//button[contains(text(),'Продолжить')]").click()
                                driver.implicitly_wait(10)
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    if driver.find_element(By.XPATH, "//div[contains(text(),'Введенный вами SMS код неверный пожалуйста попробу')]").is_displayed() == True:
                                        ...
                                        time.sleep(2)
                                        driver.find_element(By.XPATH, "//button[contains(text(),'Изменить способ оплаты')]").click()
                                        driver.find_element(By.XPATH, "//span[@class='checkbox-rect']").click()
                                        driver.find_element(By.XPATH, "//img[@alt='Payme logo']").click()
                                        driver.find_element(By.XPATH,
                                        ...
                                        driver.find_element(By.XPATH, "//input[@placeholder='__ /__']").send_keys(
                                            card_date)
                                        driver.find_element(By.XPATH, "//button[contains(text(),'Оплатить')]").click()
                                        confirm_message = bot.send_message(message.chat.id, "Код неверный или устарел. Введите последний полученный код ещё раз.")
